import{r as v,j as C}from"./index-CfHOvdKM.js";import{u as b,c as k,q as u,s as c}from"./App-CLuUYT-F.js";import{g as w,a as x,c as R,s as S,m as $}from"./createSimplePaletteValueFilter-DZU-RSgf.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return w("MuiSkeleton",t)}x("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return R({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},A,e)},r=c`
  0% {
    opacity: 1;
  }
